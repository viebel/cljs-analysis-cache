...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6750 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6750(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6751 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6751(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6752 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6752(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6753 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6753(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6754 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6754(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6755 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6755(reader);
}
});
...
var G__6759 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6760 = s.append(c);
c = G__6759;
s = G__6760;
continue;
}
