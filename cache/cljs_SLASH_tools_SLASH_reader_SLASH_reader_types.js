...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7831 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7831(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7833 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7833(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7840 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7840(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7842 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7842(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7849 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7849(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7851 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7851(reader);
}
});
...
var G__7916 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__7917 = s.append(c);
c = G__7916;
s = G__7917;
continue;
}
