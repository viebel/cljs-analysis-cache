...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_8177 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_8177(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_8182 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_8182(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8183 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8183(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8190 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8190(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8191 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8191(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8213 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8213(reader);
}
});
...
var G__8306 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__8307 = s.append(c);
c = G__8306;
s = G__8307;
continue;
}
