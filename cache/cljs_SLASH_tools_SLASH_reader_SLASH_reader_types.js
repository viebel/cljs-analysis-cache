...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7559 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7559(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7563 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7563(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7566 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7566(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7571 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7571(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7577 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7577(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7579 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7579(reader);
}
});
...
var G__7800 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__7801 = s.append(c);
c = G__7800;
s = G__7801;
continue;
}
