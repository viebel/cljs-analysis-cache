...
return cljs.core.cons(cljs.core.first(s),(function (){var G__10477 = (n - (1));
var G__10478 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__10477,G__10478) : clojure.test.check.rose_tree.exclude_nth.call(null,G__10477,G__10478));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__10503 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__10503) : f.call(null,G__10503));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10493_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__10493_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__10493_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10509_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__10509_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__10509_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__10510_SHARP_){
var G__10517 = clojure.test.check.rose_tree.root(p1__10510_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__10517) : pred.call(null,G__10517));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4529__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__10519(s__10520){
return (new cljs.core.LazySeq(null,(function (){
var s__10520__$1 = s__10520;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__10520__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__10554 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10554,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10554,(1),null);
var iterys__4525__auto__ = ((function (s__10520__$1,vec__10554,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__10519_$_iter__10522(s__10523){
return (new cljs.core.LazySeq(null,((function (s__10520__$1,vec__10554,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__10523__$1 = s__10523;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__10523__$1);
if(temp__5735__auto____$1){
var s__10523__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__10523__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__10523__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__10525 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__10524 = (0);
while(true){
if((i__10524 < size__4528__auto__)){
var child = cljs.core._nth(c__4527__auto__,i__10524);
cljs.core.chunk_append(b__10525,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__10735 = (i__10524 + (1));
i__10524 = G__10735;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10525),clojure$test$check$rose_tree$permutations_$_iter__10519_$_iter__10522(cljs.core.chunk_rest(s__10523__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10525),null);
}
} else {
var child = cljs.core.first(s__10523__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__10519_$_iter__10522(cljs.core.rest(s__10523__$2)));
}
} else {
return null;
}
...
});})(s__10520__$1,vec__10554,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__10520__$1,vec__10554,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,clojure$test$check$rose_tree$permutations_$_iter__10519(cljs.core.rest(s__10520__$1)));
} else {
var G__10740 = cljs.core.rest(s__10520__$1);
s__10520__$1 = G__10740;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10596_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__10596_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__10596_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10629_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__10629_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__10629_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__10648 = f;
var G__10649 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__10648,G__10649) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__10648,G__10649));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__10652 = f;
var G__10653 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__10652,G__10653) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__10652,G__10653));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
