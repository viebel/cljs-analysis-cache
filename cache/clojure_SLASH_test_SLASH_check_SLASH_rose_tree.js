...
return cljs.core.cons(cljs.core.first(s),(function (){var G__7369 = (n - (1));
var G__7370 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__7369,G__7370) : clojure.test.check.rose_tree.exclude_nth.call(null,G__7369,G__7370));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__7375 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__7375) : f.call(null,G__7375));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7374_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__7374_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__7374_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7379_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__7379_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__7379_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__7380_SHARP_){
var G__7382 = clojure.test.check.rose_tree.root(p1__7380_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__7382) : pred.call(null,G__7382));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4529__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__7383(s__7384){
return (new cljs.core.LazySeq(null,(function (){
var s__7384__$1 = s__7384;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__7384__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__7389 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7389,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7389,(1),null);
var iterys__4525__auto__ = ((function (s__7384__$1,vec__7389,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__7383_$_iter__7385(s__7386){
return (new cljs.core.LazySeq(null,((function (s__7384__$1,vec__7389,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__7386__$1 = s__7386;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__7386__$1);
if(temp__5735__auto____$1){
var s__7386__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__7386__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__7386__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__7388 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__7387 = (0);
while(true){
if((i__7387 < size__4528__auto__)){
var child = cljs.core._nth(c__4527__auto__,i__7387);
cljs.core.chunk_append(b__7388,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__7464 = (i__7387 + (1));
i__7387 = G__7464;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__7388),clojure$test$check$rose_tree$permutations_$_iter__7383_$_iter__7385(cljs.core.chunk_rest(s__7386__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__7388),null);
}
} else {
var child = cljs.core.first(s__7386__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__7383_$_iter__7385(cljs.core.rest(s__7386__$2)));
}
} else {
return null;
}
...
});})(s__7384__$1,vec__7389,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__7384__$1,vec__7389,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4526__auto__ = cljs.core.seq(iterys__4525__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4526__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4526__auto__,clojure$test$check$rose_tree$permutations_$_iter__7383(cljs.core.rest(s__7384__$1)));
} else {
var G__7475 = cljs.core.rest(s__7384__$1);
s__7384__$1 = G__7475;
continue;
}
} else {
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7398_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__7398_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__7398_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7400_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__7400_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__7400_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__7401 = f;
var G__7402 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__7401,G__7402) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__7401,G__7402));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__7403 = f;
var G__7404 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__7403,G__7404) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__7403,G__7404));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
