...
return cljs.core.cons(cljs.core.first(s),(function (){var G__10670 = (n - (1));
var G__10671 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__10670,G__10671) : clojure.test.check.rose_tree.exclude_nth.call(null, G__10670,G__10671));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__10682 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__10682) : f.call(null, G__10682));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10680_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__10680_SHARP_) : clojure.test.check.rose_tree.fmap.call(null, f,p1__10680_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10686_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__10686_SHARP_) : clojure.test.check.rose_tree.filter.call(null, pred,p1__10686_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__10687_SHARP_){
var G__10692 = clojure.test.check.rose_tree.root(p1__10687_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__10692) : pred.call(null, G__10692));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5480__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__10695(s__10696){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__10707 = cljs.core.first(xs__6360__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10707,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10707,(1),null);
var iterys__5476__auto__ = ((function (s__10696__$1,vec__10707,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__10695_$_iter__10697(s__10698){
return (new cljs.core.LazySeq(null,((function (s__10696__$1,vec__10707,rose,index,xs__6360__auto__,temp__5804__auto__){
return (function (){
var s__10698__$1 = s__10698;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__10698__$1);
if(temp__5804__auto____$1){
var s__10698__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__10698__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__10698__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__10700 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__10699 = (0);
while(true){
if((i__10699 < size__5479__auto__)){
var child = cljs.core._nth(c__5478__auto__,i__10699);
cljs.core.chunk_append(b__10700,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__10793 = (i__10699 + (1));
i__10699 = G__10793;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10700),clojure$test$check$rose_tree$permutations_$_iter__10695_$_iter__10697(cljs.core.chunk_rest(s__10698__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10700),null);
}
} else {
var child = cljs.core.first(s__10698__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__10695_$_iter__10697(cljs.core.rest(s__10698__$2)));
}
} else {
return null;
}
...
});})(s__10696__$1,vec__10707,rose,index,xs__6360__auto__,temp__5804__auto__))
,null,null));
});})(s__10696__$1,vec__10707,rose,index,xs__6360__auto__,temp__5804__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,clojure$test$check$rose_tree$permutations_$_iter__10695(cljs.core.rest(s__10696__$1)));
} else {
var G__10796 = cljs.core.rest(s__10696__$1);
s__10696__$1 = G__10796;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10720_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__10720_SHARP_) : clojure.test.check.rose_tree.zip.call(null, f,p1__10720_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10724_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__10724_SHARP_) : clojure.test.check.rose_tree.shrink.call(null, f,p1__10724_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__10730 = f;
var G__10731 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__10730,G__10731) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null, G__10730,G__10731));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__10732 = f;
var G__10733 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__10732,G__10733) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null, G__10732,G__10733));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
