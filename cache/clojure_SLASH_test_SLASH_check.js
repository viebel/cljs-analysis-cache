...
var vec__11868 = temp__5802__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11868,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11868,(1),null);
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__11896){
var map__11897 = p__11896;
var map__11897__$1 = cljs.core.__destructure_map(map__11897);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11897__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11897__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__11897__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__11901 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11901,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11901,(1),null);
...
var size = first__11930;
var rest_size_seq = seq__11929__$1;
var vec__11931 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11931,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11931,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq11881){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11882,G__11883,seq11881__$2);
}));
...
var map__11946 = smallest;
var map__11946__$1 = cljs.core.__destructure_map(map__11946);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11946__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__12043 = tail;
var G__12044 = current_smallest;
var G__12045 = (total_nodes_visited + (1));
var G__12046 = depth;
nodes = G__12043;
current_smallest = G__12044;
total_nodes_visited = G__12045;
depth = G__12046;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__11972_12047 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__11972_12047) : reporter_fn.call(null, G__11972_12047));

var temp__5802__auto__ = cljs.core.seq(clojure.test.check.rose_tree.children(head));
if(temp__5802__auto__){
var children = temp__5802__auto__;
var G__12048 = children;
var G__12049 = new_smallest;
var G__12050 = (total_nodes_visited + (1));
var G__12051 = (depth + (1));
nodes = G__12048;
current_smallest = G__12049;
total_nodes_visited = G__12050;
depth = G__12051;
continue;
} else {
var G__12054 = tail;
var G__12055 = new_smallest;
var G__12056 = (total_nodes_visited + (1));
var G__12057 = depth;
nodes = G__12054;
current_smallest = G__12055;
total_nodes_visited = G__12056;
depth = G__12057;
continue;
}
}
...
var G__11982_12060 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__11982_12060) : reporter_fn.call(null, G__11982_12060));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__11977_SHARP_){
var G__11983 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__11977_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__11983) : reporter_fn.call(null, G__11983));
}));
var G__11988_12062 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__11988_12062) : reporter_fn.call(null, G__11988_12062));
