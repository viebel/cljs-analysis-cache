...
var clojure$test$check$results$Result$pass_QMARK_$dyn_5981 = (function (result){
...
return clojure$test$check$results$Result$pass_QMARK_$dyn_5981(result);
}
});

var clojure$test$check$results$Result$result_data$dyn_5985 = (function (result){
var x__4428__auto__ = (((result == null))?null:result);
...
return clojure$test$check$results$Result$result_data$dyn_5985(result);
}
});
