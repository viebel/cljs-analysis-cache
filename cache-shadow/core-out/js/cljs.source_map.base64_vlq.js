...
var digit_7617 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_7618__$1 = (vlq >>> (5));
while(true){
if((vlq_7618__$1 > (0))){
var digit_7620__$1 = (digit_7617 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_7620__$1));

var G__7621 = (vlq_7618__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__7622 = (vlq_7618__$1 >>> (5));
digit_7617 = G__7621;
vlq_7618__$1 = G__7622;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_7617));
}
break;
}
...
var G__7624 = i__$1;
var G__7625 = result__$1;
var G__7626 = shift__$1;
i = G__7624;
result = G__7625;
shift = G__7626;
continue;
